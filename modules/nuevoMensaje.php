...
if(!isset($_SESSION)){
    session_start();
        ...
        if($mensaje=="") {
            echo "<center>No se puede guardar un mensaje vacio.</center>";
            echo "<br/><br/>";
            echo "<a href='base2.php'>Regresar</a>";
           
        }else {
            $query = "INSERT INTO mensajes values(default,'$user','$mensaje',now());";
            $resultado = mysqli_query($idConn,$query);            
           
            if($resultado) {
                echo("<center><br>Se ha enviando el mensaje correctamente...<br>");
                echo "<a href='base2.php'>Regresar</a>";
